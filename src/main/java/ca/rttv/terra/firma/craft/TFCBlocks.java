...
public class TFCBlocks {
   ...
   public static final Block ASH_CHEST    = register("tfc:wood/chests/ash",    new SmallChestBlock(Settings.of(Material.WOOD).strength(2.5f).sounds(BlockSoundGroup.WOOD), "ash"   ));
   ...
   public static final Block KAPOK_CHEST  = register("tfc:wood/chests/kapok",  new SmallChestBlock(Settings.of(Material.WOOD).strength(2.5f).sounds(BlockSoundGroup.WOOD), "kapok" ));
