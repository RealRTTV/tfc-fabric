...
import ca.rttv.terra.firma.craft.chest.DoubleSmallChestScreenHandler;
...
public class TFCScreenHandlerType {
   ...
   public static final ScreenHandlerType<DoubleSmallChestScreenHandler> DOUBLE_SMALL_CHEST = register("tfc:double_chest", DoubleSmallChestScreenHandler::new);
   
   @SuppressWarnings( "ResultOfMethodCallIgnored" )
   public static void init() {
      SMALL_CHEST.getClass();
      DOUBLE_SMALL_CHEST.getClass();
   }
